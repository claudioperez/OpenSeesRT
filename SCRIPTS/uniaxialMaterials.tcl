...
$m add command -label "ElasticPP" -command "uniaxialMaterialSample ElasticPP matTag=1 E=29000. yieldStrain=0.025"
$m add command -label "Steel01" -command "uniaxialMaterialSample Steel01 matTag=1 Fy=40. E=29000. b=0.1"
$m add command -label "Steel02" -command "uniaxialMaterialSample Steel02 matTag=1 Fy=40. E=29000. b=0.1 R0=15 CR1=0.925 CR2=0.15"
