...
double *ShellMITC4::computeBdrill(int node, const double shp[3][4])
{
...
const Matrix &ShellMITC4::computeBmembrane(int node, const double shp[3][4])
{
...
const Matrix &ShellMITC4::computeBbend(int node, const double shp[3][4])
{
