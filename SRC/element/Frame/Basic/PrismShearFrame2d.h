...
** ****************************************************************** */
//
// Purpose: PrismShearFrame2d is a shear-deformable frame member
// that takes rotational inertia effects into account.
//
...
public:
    // constructor
    PrismShearFrame2d(int tag, int Nd1, int Nd2, double E, double G,
    ...
    const char *getClassType() const {return "PrismShearFrame2d";};
