...
int
ForceBeamColumnCBDI2d::getNumExternalNodes() const
{
  return 2;
}

const ID &
ForceBeamColumnCBDI2d::getExternalNodes() 
{
...
int
ForceBeamColumnCBDI2d::getNumDOF() 
{
  return NEGD;
}
...
const Matrix &
ForceBeamColumnCBDI2d::getInitialStiff()
{
...
const Matrix &
ForceBeamColumnCBDI2d::getTangentStiff()
{
...
const Vector &
ForceBeamColumnCBDI2d::getResistingForce()
{
...
void
ForceBeamColumnCBDI2d::initializeSectionHistoryVariables ()
{
  for (int i = 0; i < numSections; i++) {
...
void 
ForceBeamColumnCBDI2d::zeroLoad()
{
