...
DispBeamColumnWarping3d::update(void)
{
  ...
  for (int i = 0; i < numSections; i++) {
    ...
    e(4) = oneOverL * (6.0 * xi1 * xi1 - 6.0 * xi1) * v(0) +
           (1.0 - 4.0 * xi1 + 3 * xi1 * xi1) * v(3) +
           oneOverL * (6.0 * xi1 - 6.0 * xi1 * xi1) * v(4) +
           (3.0 * xi1 * xi1 - 2.0 * xi1) * v(7);
    e(3) = -oneOverLsquare * (xi12 - 6.0) * v(0) - oneOverL * (xi6 - 4.0) * v(3) -
           oneOverLsquare * (6.0 - xi12) * v(4) - oneOverL * (xi6 - 2.0) * v(7);
    e(5) =
        (1.0 + 3.0 * xi1 * xi1 - 4.0 * xi1) * v(1) + (3.0 * xi1 * xi1 - 2.0 * xi1) * v(5);
    e(6) =
        (1.0 + 3.0 * xi1 * xi1 - 4.0 * xi1) * v(2) + (3.0 * xi1 * xi1 - 2.0 * xi1) * v(6);
    e(7) = (1.0 - 3.0 * xi1 * xi1 + 2.0 * xi1 * xi1 * xi1) * v(0) +
           L * xi1 * (1.0 - xi1) * (1.0 - xi1) * v(3) +
           (3.0 * xi1 * xi1 - 2.0 * xi1 * xi1 * xi1) * v(4) +
           L * xi1 * xi1 * (xi1 - 1.0) * v(7);
