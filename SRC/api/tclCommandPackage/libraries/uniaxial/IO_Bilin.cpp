...
#include <SRC/material/uniaxial/Bilin.h>
void *OPS_Bilin(G3_Runtime *rt)
{
  if (numBilinMaterials == 0) {
    numBilinMaterials++;
    opserr << "Modified Ibarra-Medina-Krawinkler Model with Bilinear "
              "Hysteretic Response\n";
  }
  ...
  if (numData != 23 &&
    ...
    opserr << "Invalid Args want: uniaxialMaterial Bilin tag? Ke? AsPos? "
  ...
  //  Updated: Filipe Ribeiro and Andre Barbosa
  //    opserr << "Invalid Args want: uniaxialMaterial Bilin tag? Ke? nFactor?
  ...
  //    PDNeg\n"; return 0;
  //  }																	// Updated: Filipe Ribeiro and Andre
  //  Barbosa
