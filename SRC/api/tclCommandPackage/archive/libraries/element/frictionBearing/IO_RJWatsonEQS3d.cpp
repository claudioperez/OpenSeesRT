...
#include <SRC/element/frictionBearing/RJWatsonEQS3d.h>
void *OPS_RJWatsonEQS3d()
{
  ...
  if (OPS_GetNumRemainingInputArgs() < 17) {
    ...
    opserr << "Want: RJWatsonEqsBearing eleTag iNode jNode frnMdlTag kInit -P "
              "matTag -Vy matTag -Vz matTag -T matTag -My matTag -Mz matTag "
  ...
  return new RJWatsonEQS3d(idata[0], idata[1], idata[2], *theFrnMdl, kInit,
