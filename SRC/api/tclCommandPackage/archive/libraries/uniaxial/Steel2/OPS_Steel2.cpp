...
#include <SRC/material/uniaxial/Steel2.h>
void *OPS_Steel2(void)
{
  ...
  if (numData == 3) {
    ...
    // Parsing was successful, allocate the material
    theMaterial = new Steel2(iData[0], dData[0], dData[1], dData[2], dData[3],
                             dData[4], dData[5]);
    ...
    // Parsing was successful, allocate the material
    theMaterial =
        new Steel2(iData[0], dData[0], dData[1], dData[2], dData[3], dData[4],
  ...
  if (theMaterial == 0) {
    opserr << "WARNING could not create uniaxialMaterial of type Steel2 "
              "Material\n";
    return 0;
  }
