...
// $Source:
// /usr/local/cvs/OpenSees/SRC/material/nD/feap/TclFeapMaterialCommand.cpp,v $
                                ...
                                TclBasicBuilder *theTclBuilder)
{
  ...
  if (strcmp(argv[1], "ElasticFeap") == 0 ||
      strcmp(argv[1], "FeapElastic") == 0) {
    if (argc < 5) {
  ...
  else if (strcmp(argv[1], "ViscousFeap") == 0 ||
           strcmp(argv[1], "FeapViscous") == 0) {
    if (argc < 10) {
      opserr << "WARNING invalid number of arguments\n";
      opserr << "Want: nDMaterial ViscousFeap tag? K? G? muK? muG? lamK? lamG? "
                "theta?"
             << endln;
      return 0;
    }
