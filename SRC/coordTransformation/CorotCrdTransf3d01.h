...
// CorotCrdTransf3d01.h. CorotCrdTransf3d01 provides the
// abstraction of a corotation transformation for a spatial frame element

// What: "@(#) CorotCrdTransf3d01.h, revA"

#ifndef CorotCrdTransf3d01_h
#define CorotCrdTransf3d01_h

#include <CrdTransf.h>
#include <Vector.h>
#include <Matrix.h>

class CorotCrdTransf3d01: public CrdTransf
{
public:
    CorotCrdTransf3d01(int tag, const Vector &vecInLocXZPlane,
        const Vector &rigJntOffsetI, const Vector &rigJntOffsetJ);
    
    CorotCrdTransf3d01();
    ~CorotCrdTransf3d01();
    
    const char *getClassType() const {return "CorotCrdTransf3d01";};
