...
OPS_Export void * OPS_ADD_RUNTIME_VPV(OPS_FSAMMaterial)
{
	...
	// Steel X
	UniaxialMaterial *theUniaxialMaterial1 = builder->getUniaxialMaterial(iData[0]);
	...
	// Steel Y
	UniaxialMaterial *theUniaxialMaterial2 = builder->getUniaxialMaterial(iData[1]);
	...
	UniaxialMaterial *theUniaxialMaterial3 = builder->getUniaxialMaterial(iData[2]);
	...
	UniaxialMaterial *theUniaxialMaterial4 = builder->getUniaxialMaterial(iData[2]);  
	...
	UniaxialMaterial *theUniaxialMaterial5 = builder->getUniaxialMaterial(iData[2]);
	...
	UniaxialMaterial *theUniaxialMaterial6 = builder->getUniaxialMaterial(iData[2]);  
	...
	UniaxialMaterial *theUniaxialMaterial7 = builder->getUniaxialMaterial(iData[2]);
	...
	UniaxialMaterial *theUniaxialMaterial8 = builder->getUniaxialMaterial(iData[2]);  
