...
gravRec = ""
gravRec.append([ana.recorder('Node', -xml, dataDir/"nodeforceZ.out", time=True, node=[1020, 1010, 1030, 201, 207, 301, 307, 401, 407, 501, 507, 601, 607, 701, 707, 801, 807, 901, 907, 1001, 1007, 1101, 1107, 1201, 1209, 1211, 1301, 1307, 1313, 1401, 1407, 1409, 1413, 15020, 15030, 15050, 15060 ], dof=[ 3 reaction]))
gravRec.append([ana.recorder('Node', -xml, dataDir/"nodeforceX.out", time=True, node=[1020, 1010, 1030, 201, 207, 301, 307, 401, 407, 501, 507, 601, 607, 701, 707, 801, 807, 901, 907, 1001, 1007, 1101, 1107, 1201, 1209, 1211, 1301, 1307, 1313, 1401, 1407, 1409, 1413, 15020, 15030, 15050, 15060 ], dof=[ 1 reaction]))
gravRec.append([ana.recorder('Node', -xml, dataDir/"nodeforceY.out", time=True, node=[1020, 1010, 1030, 201, 207, 301, 307, 401, 407, 501, 507, 601, 607, 701, 707, 801, 807, 901, 907, 1001, 1007, 1101, 1107, 1201, 1209, 1211, 1301, 1307, 1313, 1401, 1407, 1409, 1413, 15020, 15030, 15050, 15060 ], dof=[ 2 reaction]))
gravRec.append([ana.recorder('Node', -xml, dataDir/"nodeMoment.out", time=True, node=[1020, 1010, 1030, 201, 207, 301, 307, 401, 407, 501, 507, 601, 607, 701, 707, 801, 807, 901, 907, 1001, 1007, 1101, 1107, 1201, 1209, 1211, 1301, 1307, 1313, 1401, 1407, 1409, 1413, 15020, 15030, 15050, 15060 ], dof=[ 4 5, reaction]))
# COLUMN POTENTIAL PIN X/Y MOMENT RECORDER
gravRec.append([ana.recorder('Node', -xml, dataDir/"nodemomXY.out", time=True, node=[201, 207, 302, 306, 402, 406, 502, 506, 702, 706, 802, 806, 902, 906, 1002, 1006, 1102, 1106, 1201, 1211, 1209, 1301, 1307, 1313, 1401, 1407, 1413 ], dof=[ 4 5, reaction]))
# TOP OF COLUMN DISPLACEMENT AND ACCELERATION RECORDERS
gravRec.append([ana.recorder('Node', file=dataDir/"nodeDisp.out", time=True, node=[1408, 1302 ], dof=[ 1 2, 3 disp]))
gravRec.append([ana.recorder('Node', file=dataDir/"nodeAcc.out", time=True, node=[1408, 1302 ], dof=[ 1 2, 3 accel]))
...
brace2::GravityAnalysis, 'create', 'ga'
ga, 'analyze', 10
