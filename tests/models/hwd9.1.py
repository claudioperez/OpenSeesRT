...
# ------------------------------------------------------------------------------------------------------------------------
# MAIN MODEL CONFIGURATION SCRIPT (to run, type "source hwd9.1.tcl" into opensees)
...
dataDir = "datahwd9.1";                      # Set data directory
...
theta15NE = 66.18;                                                                              # Abutment, 15, NE, skew, angle (in, degrees)
...
model.uniaxialMaterial('ElasticPPGap',        201       , (kabutl1*cfactor) '[expr', -pabutl1*cfactor], '[expr', -gap1], 1.0e-3, damage);        # LONGITUDINAL, 'Abutment', 1
model.uniaxialMaterial('ElasticPP',               202       , (kabutt1*cfactor) '[expr', pabutt1/kabutt1]);                                                                # TRANSVERSE, 'Abutment', 1
model.uniaxialMaterial('ENT',                      2031       , 3.5*kabutv1)
model.uniaxialMaterial('ElasticPPGap',        2032       , (1.0e)+9) '[expr', -1.0e+9] -gapV, 1.0e-3, damage;
model.uniaxialMaterial('Parallel',               203, 2031, 2032);                                                                                                                                      # VERTICAL, 'Abutment', 1
# Abutment 15 NE Spring Materials
model.uniaxialMaterial('ElasticPPGap',        215       , (kabutl15NE*cfactor) '[expr', -pabutl15NE*cfactor], '[expr', -gap15NE], 1.0e-3, damage);        # LONGITUDINAL, 'Abutment', 15, NE
model.uniaxialMaterial('ElasticPP',               216       , (kabutt15NE*cfactor) '[expr', pabutt15NE/kabutt15NE]);                                                         # TRANSVERSE, 'Abutment', 15, NE
model.uniaxialMaterial('ENT',                      2171       , 3.5*kabutv15NE)
model.uniaxialMaterial('ElasticPPGap',        2172       , (1.0e)+9) '[expr', -1.0e+9] -gapV, 1.0e-3, damage;
model.uniaxialMaterial('Parallel',               217, 2171, 2172);                                                                                                                                                    # VERTICAL, 'Abutment', 15, NE
# Abutment 15 NR Spring Materials
model.uniaxialMaterial('ElasticPPGap',        218       , (kabutl15NR*cfactor) '[expr', -pabutl15NR*cfactor], '[expr', -gap15NR], 1.0e-3, damage);        # LONGITUDINAL, 'Abutment', 15, NR
model.uniaxialMaterial('ElasticPP',               219       , (kabutt15NR*cfactor) '[expr', pabutt15NR/kabutt15NR]);                                                         # TRANSVERSE, 'Abutment', 15, NR
model.uniaxialMaterial('ENT',                      2201       , 3.5*kabutv15NR)
model.uniaxialMaterial('ElasticPPGap',        2202       , (1.0e)+9) '[expr', -1.0e+9] -gapV, 1.0e-3, damage;
model.uniaxialMaterial('Parallel',               220, 2201, 2202);                                                                                                                                                    # VERTICAL, 'Abutment', 15, NR
