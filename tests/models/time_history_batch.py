...
wipeAnalysis
ana.rayleigh( 0.16352470973545075, 0.0, 0.0, 0.005473595644304753)
# rayleigh {*}[brace2::rayleigh_alpha {1 0.03} {2 0.03}]
...
file, 'mkdir', dataDir/GMdataDir;        # Create, 'data', output, 'folder', for, 'each', input, 'GM'
Tol =                            1.0e-8;
maxNumIter =              100;
printFlag =              0;
TestType =              EnergyIncr;
