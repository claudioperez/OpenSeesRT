...
# ------------------------------------------------------------------------------------------------------------------------
# MAIN MODEL CONFIGURATION SCRIPT (to run, type "source hwd5.1.tcl" into opensees)
...
dataDir = "datahwd5.1";                      # Set data directory
...
AssignHaywardSections, 'BuildOctColSectionInel', 'BuildWideOctColSectionInel'
