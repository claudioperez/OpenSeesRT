...
model.element('elasticBeamColumn', 51, 50001, 50002, A Ec, Gc, J Iy, Iz, 301, mass='[expr', mconc*A] -cMass);
...
model.element('elasticBeamColumn', 84, 80004, 904, A Ec, Gc, J Iy, Iz, 301, mass='[expr', mconc*A] -cMass);
# Bent 9 to Bent 11
for {ib = 9} {ib <= 10} {ib += 1} {
       lassign '[ReadMPR', CSDir CSType ib {-NodeNum 0}] A 'Iy', Iz J; # Cross 'Section', 'properties'
       model.element('elasticBeamColumn',, (10*ib) '[expr', 100*ib)+4] '[expr', 10000*ib+1] A Ec Gc J Iy Iz 301 -model.mass('[expr', mconc*A] -cMass);
...
model.element('elasticBeamColumn', 121, 120001, 120002, A Ec, Gc, J Iy, Iz, 301, mass='[expr', mconc*A] -cMass);
...
model.element('elasticBeamColumn', 126, 120005, 120006, A Ec, Gc, J Iy, Iz, 301, mass='[expr', mconc*A] -cMass);
