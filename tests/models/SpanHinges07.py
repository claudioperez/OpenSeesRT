...
model.uniaxialMaterial('Elastic', 501       , khlc                             )# LONGITUDINAL, 'Hinge', 5
model.uniaxialMaterial('Elastic', 502       , kht5                             )# TRANSVERSE, 'Hinge', 5
model.uniaxialMaterial('Elastic', 503       , 1.0e)+9*kips/in        # VERTICAL, 'Hinge', 5
# uniaxialMaterial ElasticPPGap        5011       , (khlc), (-phl), (-gaphl5) 1.0e-3 damage;                                                  # LONGITUDINAL Hinge 5 COMPRESSION
# uniaxialMaterial ElasticPPGap        5012       , (khlt5), (phl), (gaphl5) 1.0e-3 damage;                                                  # LONGITUDINAL Hinge 5 TENSION
# uniaxialMaterial Parallel               501        5011 5012;                                                                                                                                      # LONGITUDINAL Hinge 5
# uniaxialMaterial ElasticPP               502        kht5, pht5/kht5                                                                                                          # TRANSVERSE Hinge 5
# uniaxialMaterial Elastic               503       , 1.0e+9*kips/in                                                                                                          # VERTICAL Hinge 5
# uniaxialMaterial ENT                      5031       , 3.5*khv5
# uniaxialMaterial ElasticPPGap        5032       , (1.0e+9) [expr -1.0e+9] -gapV 1.0e-3 damage;
# uniaxialMaterial Parallel               503        5031 5032;                                                                                                                                      # VERTICAL Hinge 5
# Hinge 8 Spring Materials
model.uniaxialMaterial('Elastic', 801       , khlc                             )# LONGITUDINAL, 'Hinge', 8
model.uniaxialMaterial('Elastic', 802       , kht8                             )# TRANSVERSE, 'Hinge', 8
model.uniaxialMaterial('Elastic', 803       , 1.0e)+9*kips/in        # VERTICAL, 'Hinge', 8
# uniaxialMaterial ElasticPPGap        8011       , (khlc), (-phl), (-gaphl8) 1.0e-3 damage;                                                  # Hinge 8 longitudinal COMPRESSION
# uniaxialMaterial ElasticPPGap        8012       , (khlt8), (phl), (gaphl8) 1.0e-3 damage;                                                  # Hinge 8 longitudinal TENSION
# uniaxialMaterial Parallel               801        8011 8012;                                                                                                                                      # LONGITUDINAL Hinge 8
# uniaxialMaterial ElasticPP               802        kht8, pht8/kht8                                                                                                          # TRANSVERSE Hinge 8
# uniaxialMaterial Elastic               803       , 1.0e+9*kips/in                                                                                                          # VERTICAL Hinge 8
# uniaxialMaterial ENT                      8031       , 3.5*khv8
# uniaxialMaterial ElasticPPGap        8032       , (1.0e+9) [expr -1.0e+9] -gapV 1.0e-3 damage;
# uniaxialMaterial Parallel               803        8031 8032;                                                                                                                                      # VERTICAL Hinge 8
# Hinge 12 NE Spring Materials
model.uniaxialMaterial('Elastic', 1201       , khlc                             )# LONGITUDINAL, 'Hinge', 12, NE
model.uniaxialMaterial('Elastic', 1202       , kht12NE                      )# TRANSVERSE, 'Hinge', 12, NE
model.uniaxialMaterial('Elastic', 1203       , 1.0e)+9*kips/in        # VERTICAL, 'Hinge', 12, NE
# uniaxialMaterial ElasticPPGap        12011       , (khlc), (-phl), (-gaphl12NE) 1.0e-3 damage;                                           # Hinge 12 NE longitudinal COMPRESSION
# uniaxialMaterial ElasticPPGap        12012       , (khlt12NE), (phl), (gaphl12NE) 1.0e-3 damage;                                           # Hinge 12 NE longitudinal TENSION
# uniaxialMaterial Parallel               1201        12011 12012;                                                                                                                               # LONGITUDINAL Hinge 12 NE
# uniaxialMaterial ElasticPP               1202        kht12NE, pht12NE/kht12NE                                                                                            # TRANSVERSE Hinge 12 NE
# uniaxialMaterial Elastic               1203       , 1.0e+9*kips/in                                                                                                          # VERTICAL Hinge 12 NE
# uniaxialMaterial ENT                      12031       , 3.5*khv12NE
# uniaxialMaterial ElasticPPGap        12032       , (1.0e+9) [expr -1.0e+9] -gapV 1.0e-3 damage;
# uniaxialMaterial Parallel               1203        12031 12032;                                                                                                                               # VERTICAL Hinge 12 NE
# Hinge 12 NR Spring Materials
model.uniaxialMaterial('Elastic', 1204       , khlc                             )# LONGITUDINAL, 'Hinge', 12, NR
model.uniaxialMaterial('Elastic', 1205       , kht12NR                      )# TRANSVERSE, 'Hinge', 12, NR
model.uniaxialMaterial('Elastic', 1206       , 1.0e)+9*kips/in        # VERTICAL, 'Hinge', 12, NR
# uniaxialMaterial ElasticPPGap        12041       , (khlc), (-phl), (-gaphl12NR) 1.0e-3 damage;                                           # Hinge 12 NR longitudinal COMPRESSION
# uniaxialMaterial ElasticPPGap        12042       , (khlt12NR), (phl), (gaphl12NR) 1.0e-3 damage;                                           # Hinge 12 NR longitudinal TENSION
# uniaxialMaterial Parallel               1204        12011 12012;                                                                                                                               # LONGITUDINAL Hinge 12 NR
# uniaxialMaterial ElasticPP               1205        kht12NR, pht12NR/kht12NR                                                                                            # TRANSVERSE Hinge 12 NR
# uniaxialMaterial Elastic               1206       , 1.0e+9*kips/in                                                                                                          # VERTICAL Hinge 12 NR
# uniaxialMaterial ENT                      12061       , 3.5*khv12NR
# uniaxialMaterial ElasticPPGap        12062       , (1.0e+9) [expr -1.0e+9] -gapV 1.0e-3 damage;
