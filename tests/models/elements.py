...
for {ib = 3} {ib <= 11} {ib += 1} {
 ...
 model.geomTransf(TransfType, (10*ib) vecxzX vecxzY 0);   # PDelta transformation; vecxz is parallel to the length of the cap 'beam.'
 model.element(nonlinearBeamColumn, (1000*ib)+10), (100*ib+1), (100*ib+2) np  , (1000*ib+10) , 10*ib #(Hinge)
 rigidLink beam, (100*ib+2), 100*ib+3    #(Rigid)
 model.element(nonlinearBeamColumn, (1000*ib)+20), (100*ib+7), (100*ib+6) np  , (1000*ib+20) , 10*ib #(Hinge)
 rigidLink beam, (100*ib+6), 100*ib+5    #(Rigid)
...
for {ib = 2} {ib <= 9} {ib += 1} {
 ...
 fceCap = [lindex fceCapList, (ib-2])
 EcCap = [expr 57000.0*sqrt(fceCap*ksi_psi)/ksi_psi]
 GcCap = [expr EcCap/(2.0*(1.0+Uc))]
 model.element(elasticBeamColumn, (10000*ib)+10), (100*ib+3), (100*ib+4), A, EcCap GcCap J, Iy Iz 301, mass=(mconc*A), cMass=True)
 model.element(elasticBeamColumn, (10000*ib)+20), (100*ib+4), (100*ib+5), A, EcCap GcCap J, Iy Iz 301, mass=(mconc*A), cMass=True)
...
model.element(elasticBeamColumn, 120010, 1203, 1204, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 120020, 1204, 1205, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 120030, 1205, 1206, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 120040, 1206, 1207, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
# Bent 13 NE
lassign, [ReadMPR, CSDir, CSType, 13 {}], A Iy, Iz, J; # Cross, Section, 'properties'
model.element(elasticBeamColumn, 130010, 1303, 1304, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 130020, 1304, 1305, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
# Bent 14 NE
lassign, [ReadMPR, CSDir, CSType, 14 {}], A Iy, Iz, J; # Cross, Section, 'properties'
model.element(elasticBeamColumn, 140010, 1403, 1404, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 140020, 1404, 1405, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
...
model.element(elasticBeamColumn, 10, 1010, 10001, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 11, 10001, 10002, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 12, 10002, 10003, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 13, 10003, 10004, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 14, 10004, 204, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
# Bent 2 to Bent 5
for {ib = 2} {ib <= 4} {ib += 1} {
 ...
 model.element(elasticBeamColumn,    (10*ib),  (100*ib)+4),   (10000*ib+1), A, Ec, Gc, J, Iy Iz 301, mass=(mconc*A), cMass=True)
 model.element(elasticBeamColumn, (10*ib)+1), (10000*ib+1),   (10000*ib+2), A, Ec, Gc, J, Iy Iz 301, mass=(mconc*A), cMass=True)
 model.element(elasticBeamColumn, (10*ib)+2), (10000*ib+2),   (10000*ib+3), A, Ec, Gc, J, Iy Iz 301, mass=(mconc*A), cMass=True)
 model.element(elasticBeamColumn, (10*ib)+3), (10000*ib+3),   (10000*ib+4), A, Ec, Gc, J, Iy Iz 301, mass=(mconc*A), cMass=True)
 model.element(elasticBeamColumn, (10*ib)+4), (10000*ib+4), (100*(ib+1)+4), A, Ec, Gc, J, Iy Iz 301, mass=(mconc*A), cMass=True)

# Bent 5 to Bent 6
lassign, [ReadMPR, CSDir, CSType, 5 {-NodeNum, 0}], A Iy, Iz, J; # Cross, Section, 'properties'
for node in range(5):
{
  50: model.element(elasticBeamColumn,    504, 50001, A, Ec, Gc, J, Iy, Iz, 301, mass=mconc*A, cMass=True),
  51: model.element(elasticBeamColumn,  50001, 50002, A, Ec, Gc, J, Iy, Iz, 301, mass=mconc*A, cMass=True),
  52: model.element(elasticBeamColumn,  50002, 50003, A, Ec, Gc, J, Iy, Iz, 301, mass=mconc*A, cMass=True),
  53: model.element(elasticBeamColumn,  50003, 50004, A, Ec, Gc, J, Iy, Iz, 301, mass=mconc*A, cMass=True),
  54: model.element(elasticBeamColumn,  50004,   604, A, Ec, Gc, J, Iy, Iz, 301, mass=mconc*A, cMass=True),
}
...
model.element(elasticBeamColumn, 80,   804, 80001, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 81, 80001, 80002, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 82, 80002, 80003, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 83, 80003, 80004, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 84, 80004,   904, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
...
model.element(elasticBeamColumn, 110,   1104, 110001, A, Ec, Gc, J, Iy, Iz, 301, mass=mconc*A, cMass=True);
model.element(elasticBeamColumn, 111, 110001, 110002, A, Ec, Gc, J, Iy, Iz, 301, mass=mconc*A, cMass=True);
model.element(elasticBeamColumn, 112, 110002, 110003, A, Ec, Gc, J, Iy, Iz, 301, mass=mconc*A, cMass=True);
model.element(elasticBeamColumn, 113, 110003, 110004, A, Ec, Gc, J, Iy, Iz, 301, mass=mconc*A, cMass=True);
model.element(elasticBeamColumn, 114, 110004,   1205, A, Ec, Gc, J, Iy, Iz, 301, mass=mconc*A, cMass=True);
...
model.element(elasticBeamColumn, 120,   1204, 120001, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 121, 120001, 120002, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 122, 120002, 120003, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 123, 120003, 120004, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 124, 120004,   1304, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
...
model.element(elasticBeamColumn, 125,   1206, 120005, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 126, 120005, 120006, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 127, 120006, 120007, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 128, 120007, 120008, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 129, 120008,   1315, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);

# Bent 13 NE to Bent 14 NE
lassign, [ReadMPR, CSDir, CSType, 13 {-NodeNum, 0}], A Iy, Iz, J; # Cross, Section, 'properties'
model.element(elasticBeamColumn, 130, 1304, 130001, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
lassign, [ReadMPR, CSDir, CSType, 13 {-NodeNum, 1}], A Iy, Iz, J; # Cross, Section, 'properties'
model.element(elasticBeamColumn, 131, 130001, 130002, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
lassign, [ReadMPR, CSDir, CSType, 13 {-NodeNum, 2}], A Iy, Iz, J; # Cross, Section, 'properties'
model.element(elasticBeamColumn, 132, 130002, 130003, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
lassign, [ReadMPR, CSDir, CSType, 13 {-NodeNum, 3}], A Iy, Iz, J; # Cross, Section, 'properties'
model.element(elasticBeamColumn, 133, 130003, 130004, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
lassign, [ReadMPR, CSDir, CSType, 13 {-NodeNum, 4}], A Iy, Iz, J; # Cross, Section, 'properties'
model.element(elasticBeamColumn, 134, 130004, 1404, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
# Bent 13 NR to Bent 14 NR
lassign, [ReadMPR, CSDir, CSType, 13 {-NodeNum, 5}], A Iy, Iz, J; # Cross, Section, 'properties'
model.element(elasticBeamColumn, 135, 1315, 130005, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
lassign, [ReadMPR, CSDir, CSType, 13 {-NodeNum, 6}], A Iy, Iz, J; # Cross, Section, 'properties'
model.element(elasticBeamColumn, 136, 130005, 130006, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
lassign, [ReadMPR, CSDir, CSType, 13 {-NodeNum, 7}], A Iy, Iz, J; # Cross, Section, 'properties'
model.element(elasticBeamColumn, 137, 130006, 130007, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
lassign, [ReadMPR, CSDir, CSType, 13 {-NodeNum, 8}], A Iy, Iz, J; # Cross, Section, 'properties'
model.element(elasticBeamColumn, 138, 130007, 130008, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 139, 130008, 1415, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
...
model.element(elasticBeamColumn, 140,   1404, 140001, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 141, 140001, 140002, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 142, 140002, 140003, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 143, 140003, 140004, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 144, 140004,  15010, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);

# Bent 14 NR to Abut 15 NR
lassign, [ReadMPR, CSDir, CSType, 14 {-NodeNum, 5}], A Iy, Iz, J; # Cross, Section, 'properties'
model.element(elasticBeamColumn, 145,   1415, 140005, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 146, 140005, 140006, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 147, 140006, 140007, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 148, 140007, 140008, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);
model.element(elasticBeamColumn, 149, 140008,  15040, A, Ec, Gc, J, Iy, Iz, 301, mass=(mconc*A), cMass=True);

# ABUTMENT ELEMENTS
model.element(elasticBeamColumn,  1000,  1020,  1010, (1.0e)+9) Ec, Gc, (1.0e+9) [expr, 1.0e+9], (1.0e+9) 301; # abut-1
model.element(elasticBeamColumn,  1001,  1010,  1030, (1.0e)+9) Ec, Gc, (1.0e+9) [expr, 1.0e+9], (1.0e+9) 301; # abut-1
model.element(elasticBeamColumn, 15000, 15020, 15010, (1.0e)+9) Ec, Gc, (1.0e+9) [expr, 1.0e+9], (1.0e+9) 301; # abut-15NE
model.element(elasticBeamColumn, 15001, 15010, 15030, (1.0e)+9) Ec, Gc, (1.0e+9) [expr, 1.0e+9], (1.0e+9) 301; # abut-15NE
model.element(elasticBeamColumn, 15002, 15050, 15040, (1.0e)+9) Ec, Gc, (1.0e+9) [expr, 1.0e+9], (1.0e+9) 301; # abut-15NR
model.element(elasticBeamColumn, 15003, 15040, 15060, (1.0e)+9) Ec, Gc, (1.0e+9) [expr, 1.0e+9], (1.0e+9) 301; # abut-15NR
