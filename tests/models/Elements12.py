...
# COLUMN ELEMENTS **WITH COLUMN PINS**
...
close, fpvecxzY
np = 4;                                                                      # number, of, integration, points, for, nonlinear, curvature, distribution-- np=2, for, linear, distribution, ok
locations = 0.0
for {ip = 1} {ip < np} {ip += 1} {
       locations.append([expr ip/(1.0*np-1)];}; # locations 'of', Fixed 'Location', integration 'points', for 'nonlinear', curvature distribution)
# Bent 2
...
for {ip = 1} {ip < np} {ip += 1} {
       secTags.append(2010;};)
integration = "FixedLocation np secTags locations"
model.element('forceBeamColumn',         2010, 201, 202, 20, integration);        #(Hinge, with, 'Fixed', Location, 'integration', points, point, 'at', BASE, 'has', PIN, 'fiber', section)
rigidLink, 'beam', 202, 203;                                                                                    #(Rigid)
secTags = 290000
for {ip = 1} {ip < np} {ip += 1} {
       secTags.append(2020;};)
integration = "FixedLocation np secTags locations"
model.element('forceBeamColumn',        2020, 207, 206, 20, integration);        #(Hinge, with, 'Fixed', Location, 'integration', points, point, 'at', BASE, 'has', PIN, 'fiber', section)
...
for {ib = 3} {ib <= 11} {ib += 1} {
       ...
       secTags = 290000
       for {ip = 1} {ip < np} {ip += 1} {
              secTags.append([expr 1000*ib+10];};)
       integration = "FixedLocation np [lreverse secTags] locations"
       model.element('forceBeamColumn',        , (1000*ib)+10) '[expr', 100*ib+1] '[expr', 100*ib+2] '[expr', 10*ib]  integration;        #(Hinge, with 'Fixed', Location 'integration', points, point 'at', TOP 'has', PIN 'fiber', section)
       rigidLink 'beam',, (100*ib+2) '[expr', 100*ib+3];                            #(Rigid)
       secTags = 290000
       for {ip = 1} {ip < np} {ip += 1} {
              secTags.append([expr 1000*ib+20];};)
       integration = "FixedLocation np [lreverse secTags] locations"
       model.element('forceBeamColumn',        , (1000*ib)+20) '[expr', 100*ib+7] '[expr', 100*ib+6] '[expr', 10*ib]  integration;        #(Hinge, with 'Fixed', Location 'integration', points, point 'at', TOP 'has', PIN 'fiber', section)
...
secTags = 1290000
for {ip = 1} {ip < np} {ip += 1} {
       secTags.append(12010;};)
integration = "FixedLocation np secTags locations"
model.element('forceBeamColumn',         12010, 1201, 1202, 120, integration);        #(Hinge, with, 'Fixed', Location, 'integration', points, point, 'at', BASE, 'has', PIN, 'fiber', section)
rigidLink, 'beam', 1202, 1203;                                                                                     #(Rigid)
secTags = 1290000
for {ip = 1} {ip < np} {ip += 1} {
       secTags.append(12020;};)
integration = "FixedLocation np secTags locations"
model.element('forceBeamColumn',         12020, 1209, 1208, 120, integration);        #(Hinge, with, 'Fixed', Location, 'integration', points, point, 'at', BASE, 'has', PIN, 'fiber', section)
rigidLink, 'beam', 1208, 1207;                                                                                     #(Rigid)
secTags = 1290000
for {ip = 1} {ip < np} {ip += 1} {
       secTags.append(12030;};)
integration = "FixedLocation np secTags locations"
model.element('forceBeamColumn',         12030, 1211, 1210, 120, integration);        #(Hinge, with, 'Fixed', Location, 'integration', points, point, 'at', BASE, 'has', PIN, 'fiber', section)
...
secTags = 1390000
for {ip = 1} {ip < np} {ip += 1} {
       secTags.append(13010;};)
integration = "FixedLocation np secTags locations"
model.element('forceBeamColumn',         13010, 1301, 1302, 130, integration);        #(Hinge, with, 'Fixed', Location, 'integration', points, point, 'at', BASE, 'has', PIN, 'fiber', section)
rigidLink, 'beam', 1302, 1303;                                                                                     #(Rigid)
secTags = 1390000
for {ip = 1} {ip < np} {ip += 1} {
       secTags.append(13020;};)
integration = "FixedLocation np secTags locations"
model.element('forceBeamColumn',         13020, 1307, 1306, 130, integration);        #(Hinge, with, 'Fixed', Location, 'integration', points, point, 'at', BASE, 'has', PIN, 'fiber', section)
...
secTags = 1390000
for {ip = 1} {ip < np} {ip += 1} {
       secTags.append(14010;};)
integration = "FixedLocation np secTags locations"
model.element('forceBeamColumn',         14010, 1401, 1402, 140, integration);        #(Hinge, with, 'Fixed', Location, 'integration', points, point, 'at', BASE, 'has', PIN, 'fiber', section)
rigidLink, 'beam', 1402, 1403;                                                                                     #(Rigid)
secTags = 1390000
for {ip = 1} {ip < np} {ip += 1} {
       secTags.append(14020;};)
integration = "FixedLocation np secTags locations"
model.element('forceBeamColumn',         14020, 1407, 1406, 140, integration);        #(Hinge, with, 'Fixed', Location, 'integration', points, point, 'at', BASE, 'has', PIN, 'fiber', section)
rigidLink, 'beam', 1406, 1405;                                                                                     #(Rigid)
secTags = 1390000
for {ip = 1} {ip < np} {ip += 1} {
       secTags.append(14030;};)
integration = "FixedLocation np secTags locations"
model.element('forceBeamColumn',         14030, 1409, 1408, 140, integration);        #(Hinge, with, 'Fixed', Location, 'integration', points, point, 'at', BASE, 'has', PIN, 'fiber', section)
