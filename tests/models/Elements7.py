...
model.element('nonlinearBeamColumn', 2010, 2010, 202, np, 2010, 20); #(Hinge)
rigidLink, 'beam', 202, 203;                                                                              #(Rigid)
model.element('nonlinearBeamColumn', 2020, 2070, 206, np, 2020, 20); #(Hinge)
...
model.element('nonlinearBeamColumn', 12010, 12010, 1202, np, 12010, 120); #(Hinge)
rigidLink, 'beam', 1202, 1203;                                                                       #(Rigid)
model.element('nonlinearBeamColumn', 12020, 12090, 1208, np, 12020, 120); #(Hinge)
rigidLink, 'beam', 1208, 1207;                                                                       #(Rigid)
model.element('nonlinearBeamColumn', 12030, 12110, 1210, np, 12030, 120); #(Hinge)
...
model.element('nonlinearBeamColumn', 13010, 13010, 1302, np, 13010, 130); #(Hinge)
rigidLink, 'beam', 1302, 1303;                                                                       #(Rigid)
model.element('nonlinearBeamColumn', 13020, 13070, 1306, np, 13020, 130); #(Hinge)
...
model.element('nonlinearBeamColumn', 14010, 14010, 1402, np, 14010, 140); #(Hinge)
rigidLink, 'beam', 1402, 1403;                                                                       #(Rigid)
model.element('nonlinearBeamColumn', 14020, 14070, 1406, np, 14020, 140); #(Hinge)
rigidLink, 'beam', 1406, 1405;                                                                       #(Rigid)
model.element('nonlinearBeamColumn', 14030, 14090, 1408, np, 14030, 140); #(Hinge)
