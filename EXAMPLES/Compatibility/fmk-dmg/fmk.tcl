...
set inFilename ExtEleForcesFloorsgravityForceForce.out
...
# ==== set GM properties 
# set Nfactor    {2.1855	1.4989	2.6423	3.6167	4.0660	2.5945	2.2389	1.9079	1.1193	2.3645	0.8880 0.00102 1.0}; # 0.5/980=0.00051 cm/s2 0.2/980=0.0002
# set motionName {RSN1183 RSN1541 RSN1213 RSN1237 RSN1261 RSN1436 RSN1471  RSN1490  RSN1545  RSN3747  RSN5825 LA3536PPhor sin};                           # for nonlinear result 
# set motionNameLIN {RSN118301 RSN154101 RSN121301 RSN123701 RSN126101 RSN143601 RSN147101  RSN149001  RSN154501  RSN374701  RSN582501 LA3536PPhor01 sin01};  # for linear result

# ==== New GM properties for T=3.4s  2%-50 years
# set Nfactor    {1.3112	2.6455	1.3329	3.4161	4.9494	3.5776	2.6670	1.4691	1.3983	1.4237	1.3658 1.0};
# set motionName {RSN185 RSN838 RSN1193 RSN1213 RSN1223 RSN1430 RSN1436 RSN1541 RSN1545 RSN1551 RSN6953 LA3536PPhor};
# set motionNameLIN {RSN18501 RSN83801 RSN119301 RSN121301 RSN122301 RSN143001 RSN143601 RSN154101 RSN154501 RSN155101 RSN695301 LA3536PPhor01};

# ==== New GM properties for T=3.4s  1%-50 years
# set Nfactor    {1.6582	3.6838	3.3457	1.6857	4.1181	4.5244	3.3729	1.8579	1.7683	2.3702	2.6552 0.00102};
# set motionName {RSN185 RSN736 RSN838 RSN1193 RSN1277 RSN1430 RSN1436 RSN1541 RSN1545 RSN2655 RSN3670 LA3536PPhor};
# set motionNameLIN {RSN18501 RSN73601 RSN83801 RSN119301 RSN127701 RSN143001 RSN143601 RSN154101 RSN154501 RSN265501 RSN367001 LA3536PPhor01};

# set Nfactor      {1.6582	3.3457	1.6857	4.3202	6.2593	4.5245	3.3729	1.8579	1.7684	1.8005	1.7273 1.0};
# set motionName   {RSN185 RSN838 RSN1193 RSN1213 RSN1223 RSN1430 RSN1436 RSN1541 RSN1545 RSN1551 RSN6953 LA3536PPhor};
# set motionNameLIN {RSN18501 RSN83801 RSN119301 RSN121301 RSN122301 RSN143001 RSN143601 RSN154101 RSN154501 RSN155101 RSN695301 LA3536PPhor01};
...
# ==== set panel zone dimention
    # set colSizes     {W24X335 W24X335 W24X335 W24X335 W24X279 W24X279 W24X279 W24X279 W24X279 W24X279 W24X229 W24X229 W24X229 W24X162 W24X162 W24X162 W24X117 W24X117 W24X94 W24X94};
	# set colExtSizes  $colSizes
    # set colExtSizes  {HSS15X15X2 HSS15X15X5/4 HSS15X15X5/4 HSS15X15X5/4 HSS15X15X1 HSS15X15X1 HSS15X15X1 HSS15X15X1 HSS15X15X1 HSS15X15X1 HSS15X15X1 HSS15X15X1 HSS15X15X1 HSS15X15X3/4 HSS15X15X3/4 HSS15X15X3/4 HSS15X15X3/4 HSS15X15X3/4 HSS15X15X1/2 HSS15X15X1/2}
# set beamSizes {W30X99 W30X99  W30X99  W30X99 W30X108 W30X108 W30X108 W30X108 W30X108 W30X108 W30X99 W30X99  W30X99  W30X99  W30X99  W30X99 W27X84  W27X84  W24X62  W21X50};	
 



# set dataDir LA20Story-testISD-$pDamp-0.1dt;	    # set up name of data directory
...
set recordAll "YES";  #<-----
if {$recordAll == "YES"} {
    set cmd "recorder Node -dT $dt -file $dataDir/floorDispCLine1$damp$motion$colType$beamType.out  -time -node $nodeListCLine1 -dof 1 disp"; eval $cmd;
...
# set cmd "recorder Node -dT $dt -file $dataDir/motionAccel$damp$motion$colType$beamType.out -timeSeries 10 -time -node 1 -dof 1 accel; "; eval $cmd;
...
while {$ok == 0 && $currentTime < $tFinal} {
    ...
    if {$ok != 0} {
	quit
	puts "\n\n\n CentralDifference Step \n\n\n"
	algorithm Linear
	integrator CentralDifference
	set ok [analyze 10 1.0e-14]
	test $testType $Tol $numStep
	algorithm Newton
	integrator Newmark 0.5 0.25
	set cdFile [open $dataDir/centralDiffStep.txt a]
	puts $cdFile "[getTime]"
	close $cdFile
    }
